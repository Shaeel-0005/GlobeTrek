    ...
    <section className="hero flex flex-col items-center justify-center h-screen">
      ...
      <div className="content flex ">
        <div className="left flex flex-col ">
          ...
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Distinctio, deserunt! Architecto nihil nostrum, maiores ducimus, natus, quod officia dolore aperiam error praesentium tempora assumenda? Earum nemo repellat aut velit ab.</p>
