...
const Hero = () => {
  return (
    ...
    ">
      ...
      src={Hero01}
      alt="Hero Background"
      className="absolute top-30 left-40 w-50 h-80  "
      />
      <img
      src={Hero02}
      alt="Hero Background"
      className="absolute top-30 left-40 w-24 h-24  "
      />
      <img
      src={Hero03}
      alt="Hero Background"
      ...
      <div className="hero-content flex flex-row items-center justify-center h-full w-full px-8">
        ...
        <div className="heading flex flex-col item-center justify-center text-black bottom-10 w-[70%] pr-10 z-10">
