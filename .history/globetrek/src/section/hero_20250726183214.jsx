  ...
  return (
    <section className="hero flex flex-col items-center justify-center h-screen">
      ...
      <div className="hero-content flex flex-row items-center justify-center h-full w-full px-8">
        ...
        <div className="heading flex flex-col item-center justify-center text-black bottom-10 w-[70%]">
          <h1 className="text-center   text-[8rem] w-[60vw] leading-none pl-[20%]">
            HIKING/
          </h1>
          <h1 className="text-center text-[8rem] w-[60vw] leading-none pr-[10%]">
            TREKKING
          </h1>
          <h1 className="text-right text-[8rem]  w-[60vw] leading-none pr-10">
            TOURS
          </h1>
        </div>
