  ...
  return (
    <section className="hero relative flex flex-col items-center justify-center h-screen overflow-hidden">
      ...
      <img
        src={Hero01}
        alt="Hero Background"
        className="absolute top-[13%] left-[30%] w-32 h-40 sm:w-40 sm:h-52 lg:w-60 lg:h-72"
      />
      <img
        src={Hero02}
        alt="Hero Background"
        className="absolute top-[30%] left-[80%] w-32 h-40 sm:w-40 sm:h-52 lg:w-60 lg:h-72"
      />
      <img
        src={Hero03}
        alt="Hero Background"
        className="absolute top-[60%] left-[20%] w-32 h-40 sm:w-40 sm:h-52 lg:w-60 lg:h-72"
      />
      ...
      <div className="hero-content flex flex-col md:flex-row items-center justify-center h-full w-full px-4 sm:px-8 md:px-12 z-10 gap-y-10 md:gap-y-0">
        ...
        {/* Heading */}
        <div className="heading flex flex-col items-center justify-center w-full md:w-[60%] px-2">
          <h1 className="text-[2.5rem] sm:text-[4rem] md:text-[6rem] lg:text-[8rem] leading-none text-right">HIKING/</h1>
          <h1 className="text-[2.5rem] sm:text-[4rem] md:text-[6rem] lg:text-[8rem] leading-none text-center w-full">TREKKING</h1>
          <h1 className="text-[2.5rem] sm:text-[4rem] md:text-[6rem] lg:text-[8rem] leading-none text-right w-full pr-4">TOURS</h1>
        </div>
