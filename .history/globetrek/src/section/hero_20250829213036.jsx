  ...
  return (
    <section className="hero relative flex flex-col items-center justify-center h-screen overflow-hidden">
      ...
      <img
        src={Hero02}
        alt="boat image"
        className="absolute top-[20%] left-[80%] w-32 h-40 sm:w-40 sm:h-52 lg:w-50 lg:h-62"
      />
      <img
        src={Hero03}
        alt="hiking image"
        className="absolute top-[62%] left-[35%] w-32 h-40 sm:w-40 sm:h-52 lg:w-50 lg:h-62"
      />
      ...
      <div className="hero-content flex flex-col md:flex-row items-center justify-center h-full w-full px-4 sm:px-8 md:px-12 z-10 gap-y-10 md:gap-y-0">
        ...
        <div className="heading flex flex-col items-center justify-center w-full md:w-[60%] px-2 bottom-10 text-[#2E2E2E]">
          <h1 className="text-[2.5rem] sm:text-[4rem] md:text-[6rem] tracking-tight lg:text-[8rem] leading-none text-right w-full">
            HIKING/
          </h1>
          <h1 className="text-[2.5rem] sm:text-[4rem] md:text-[6rem] tracking-tight lg:text-[8rem] leading-none text-left w-full pr-8">
            TREKKING
          </h1>
          <h1 className="text-[2.5rem] sm:text-[4rem] md:text-[6rem]tracking-tight lg:text-[8rem] leading-none text-center w-full pl-[45%]">
            TOURS
          </h1>
        </div>
        ...
        <div className="right-content flex flex-col items-start justify-end h-[20vh] md:h-[35vh] w-full md:w-[20%] text-center md:text-right px-4">
          <p className="text-sm sm:text-base">
           Save your stories. See your journeys. Relive your adventures on a map of memories.
          </p>
        </div>
      </div>
    </section>
