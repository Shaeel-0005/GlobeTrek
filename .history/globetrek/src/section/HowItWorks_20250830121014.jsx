  ...
  const steps = [
    {
      ...
      icon: <FaRegCalendarAlt size={40} className="text-adventure-green" />,
    },
    {
      number: "02",
      title: "Pack",
      ...
      icon: <FaSuitcaseRolling size={40} className="text-adventure-green" />,
    },
    {
      number: "03",
      title: "Go",
      ...
      icon: <FaPlaneDeparture size={40} className="text-adventure-green" />,
    },
  ];
          ...
          {steps.map((step, index) => (
            <div key={step.number} className="relative group">
              ...
              <div className="relative bg-white rounded-2xl p-8 shadow-card hover:shadow-adventure transition-all duration-300 group-hover:-translate-y-2 border border-adventure-green/10">
                ...
                <div className="w-16 h-16 mx-auto mb-6 flex items-center justify-center rounded-xl overflow-hidden bg-adventure-green-light/50">
                  {step.icon}
                </div>
