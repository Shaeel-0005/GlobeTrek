  ...
  return (
    <section className="hero relative flex flex-col items-center justify-center h-screen overflow-hidden">
      ...
      <img
        src={Hero01}
        alt="snow image"
        className="absolute top-[16%] left-[25%] w-32 h-40 sm:w-40 sm:h-52 lg:w-50 lg:h-62"
      />
      <img
        src={Hero02}
        alt="Hero Background"
        className="absolute top-[30%] left-[80%] w-32 h-40 w-32 h-40 sm:w-40 sm:h-52 lg:w-50 lg:h-62"
      />
      <img
        src={Hero03}
        alt="Hero Background"
        className="absolute top-[65%] left-[20%] w-32 h-40w-32 h-40 sm:w-40 sm:h-52 lg:w-50 lg:h-62"
      />
