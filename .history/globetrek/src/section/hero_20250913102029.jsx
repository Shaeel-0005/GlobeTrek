...
const Hero = () => {
  ...
  return (
    ...
    <div className="relative min-h-screen flex items-center">
      ...
      <div
        className="absolute inset-0 bg-cover bg-center bg-no-repeat h-[150vh]"
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="text-white space-y-8">
          <div className="space-y-2">
            ...
            <h1 className="text-5xl md:text-6xl lg:text-8xl font-bold leading-tighter tracking-tight">
              EVERY JOURNEY'S STORY
            </h1>
          </div>

          <p className="text-lg text-white/90 max-w-xl">
            curated itineraries, local eDiscover xperiences, and hassle-free
  ...
  <div className="bg-white/10 backdrop-blur-lg border border-white/20 p-8 rounded-2xl text-white shadow-lg">
    {/* Traveler Avatars */}
