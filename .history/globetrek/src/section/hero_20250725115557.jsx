    ...
    <>
      ...
      <motion.div style={{ y }} className="absolute top-0 left-0 w-full">
        <div className="space-y-8 px-4 max-w-4xl mx-auto mt-20">
          <img src={Hero01} alt="Snow" className="w-full rounded-lg shadow-md" />
          <img src={Hero02} alt="Venice" className="w-full rounded-lg shadow-md" />
          <img src={Hero03} alt="Hiker" className="w-full rounded-lg shadow-md" />
        </div>
      </motion.div>
    </section>
    </>
