...
const Hero = () => {
  ...
  return (
    <div className="scroll-smooth bg-gradient-to-b from-white via-gray-50 to-gray-100 text-[#2E2E2E]">
      ...
      {/* Hero Section */}
      <section className="relative h-[350vh] flex flex-col items-center">
        {/* Sticky Heading */}
        <motion.div
          className="sticky top-28 z-20 flex items-center justify-center h-40"
          initial={{ scale: 1 }}
        ...
        {/* Storytelling Paragraphs w/ Images */}
          ...
          {paragraphs.map((item, i) => (
            ...
            >
              ...
              <motion.img
                ...
                initial={{ scale: 0.8, rotate: i % 2 === 0 ? -5 : 5 }}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10 w-full max-w-6xl z-10">
          {[
            ...
            <motion.div
              ...
              whileTap={{ scale: 0.97 }}
              className="relative bg-white rounded-2xl shadow-2xl p-8 flex flex-col items-center text-center cursor-pointer transition"
            >
              <motion.img
                src={card.img}
                alt={card.title}
