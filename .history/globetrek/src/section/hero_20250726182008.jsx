  ...
  return (
    <section className="hero flex flex-col items-center justify-center h-screen">
      ...
      <div className="hero-content flex flex-row items-center justify-center h-full w-full px-8">
        ...
        <div className="heading flex flex-col items-center justify-center text-black w-[70%]">
          <h1 className="text-center  text-[8rem] leading-none">HIKING/</h1>
          <h1 className="text-left text-[8rem] leading-none">TREKKING</h1>
          <h1 className="text-right text-[8rem] leading-none">TOURS</h1>
        </div>
