...
const Hero = () => {
  ...
  const { scrollYProgress } = useScroll({
    target: containerRef,
    offset: ["start start", "end end"], // track Hero section progress
  });

  // Parallax mapping (heading + images)
  const headingY = useTransform(scrollYProgress, [0, 1], [0, -200]);
  const headingScale = useTransform(scrollYProgress, [0, 0.6], [1, 0.8]);
