...
const Hero = () => {
  return (
    ...
    bg-[length:100px_100px,100px_100px,100px_100px]
    bg-no-repeat
    bg-[position:top_left,top_right,bottom_left] bg-fixed bg-cover bg-center bg-[color:rgba(0,0,0,0.5)] text-white
    "
    style={{ backgroundImage: `url('${Hero01}'),url('${Hero02}'),url('${Hero03}')` }}>
