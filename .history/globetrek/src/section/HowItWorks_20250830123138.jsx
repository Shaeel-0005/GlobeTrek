...
const HowItWorks = () => {
  ...
  return (
    <section className="py-24 bg-gradient-to-b from-white to-[#1447E6]/10">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8 lg:gap-12">
          {steps.map((step, index) => (
            <div key={step.number} className="relative group">
              ...
              {/* Card */}
              <div className="relative bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 group-hover:-translate-y-2 border border-[#1447E6]/20">
        ...
        <div className="text-center mt-16">
          <div className="bg-white rounded-2xl p-8 shadow-lg border border-[#1447E6]/20 max-w-2xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <button className="bg-[#1447E6] text-white px-8 py-3 rounded-lg font-medium hover:bg-[#0F36B0] transition-colors shadow-md">
                Get Started Today
              </button>
              <button className="text-[#1447E6] font-medium hover:text-[#0F36B0] transition-colors">
                Learn More →
              </button>
            </div>
          </div>
