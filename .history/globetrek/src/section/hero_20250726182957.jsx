  ...
  return (
    <section className="hero flex flex-col items-center justify-center h-screen">
      ...
      <div className="hero-content flex flex-row items-center justify-center h-full w-full px-8">
        <div className="left-content flex flex-col  items-start justify-end h-[60vh] w-[15%]">
        ...
        <div className="heading flex flex-col item-center justify-center text-black w-[70%]">
        ...
        <div className="right-content flex flex-col items-start justify-end h-[40vh]  w-[15%] bottom-20">
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Maxime rem ipsum accusamus!</p>
        </div>
