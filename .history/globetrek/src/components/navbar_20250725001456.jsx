...
const Navbar = () => {
  return (
    <section className="navbar flex items-center justify-between px-8 py-4 text-black bg-trnasparent backdrop-blur-md">
      ...
      <ul className="navbar-links flex flex-row gap-4 list-none text-black ">
        ...
        <li><a href="#exploreWorld" className='no-underline  hover:text-blue-400'>EXPLORE WORLD World</a></li>
      </ul>
