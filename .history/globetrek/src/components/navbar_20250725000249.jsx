...
const Navbar = () => {
  return (
    <section className="navbar flex items-center justify-between px-8 py-4 text-white bg-trnasparent backdrop-blur-md">
      
      <div className="navbar-logo text-xl font-bold">
        MyLogo
      </div>

      <ul className="navbar-links flex flex-row gap-4 list-none">
