...
import { ArrowLeft, MapPin, Calendar, Camera, User, LogOut, Plane, Plus, Eye } from 'lucide-react';
...
// console.log(selectedJournal)
  ...
  i handleViewJournal(journal.id){
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-200/50">
            <div className="flex items-center justify-between">
              <div>
                <h2 className="text-2xl font-bold text-gray-900 mb-2">Travel Journal</h2>
                <p className="text-gray-600">Your documented adventures and memories</p>
              </div>
        ...
        {journals.length > 0 ? (
          ...
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 mb-6">Start documenting your travels and adventures!</p>
            <button
              onClick={() => navigate('/add-journal')}
          ...
          <div className="bg-white rounded-xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-auto">
            ...
            <div className="p-6">
              ...
              {selectedJournal.description && (
                <div className="mb-6">
                  <h3 className="text-lg font-semibold text-gray-900 mb-3">Journey Description</h3>
              ...
              {selectedJournal.mishaps && (
                <div className="mb-6">
                  <h3 className="text-lg font-semibold text-gray-900 mb-3">Mishaps & Challenges</h3>
