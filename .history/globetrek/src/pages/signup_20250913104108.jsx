...
export default function Signup() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center inset-0 bg-black/30 backdrop-blur-md transition-opacity">
      <div className="bg-wshite p-8 rounded-lg shadow-lg max-w-md w-full">
